...
{
    public class YoufferMembership : MembershipProvider
    {
        #region Not Used
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            YoufferProvider provider = new YoufferProvider();
            WebYoufferUserModel user = provider.Login(username, password);
        ...
        {
            if (YoufferSecurity.GetYoufferUser() != null)
            {
                return new MembershipUser("MyMembershipProvider", username, YoufferSecurity.GetYoufferUser().UserId, YoufferSecurity.GetYoufferUser().UserId, null, null, true, false, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue, DateTime.MinValue);
            }
            else
            {
                return null;
